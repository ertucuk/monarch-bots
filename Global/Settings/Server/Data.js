module.exports = {
    logs: {
        ...
        complaint: 'itiraz-log',
        solver: 'sorun-çözme',
        tagjoin: 'tag-alanlar',
        tagleave: 'tag-salanlar',
        staff: 'yetkiye-başlayan',
        upstaff: 'yetki-yükselenler',
        unstaff: 'yetki-salanlar',
        staffblock: 'yetki-engel',
        staffremove: 'yetki-çekilen',
        taskend: 'görevi-bitti',
        excuse: 'mazeret-log',
    ...
    emojis: [
        ...
        { name: 'arrow', url: 'https://cdn.discordapp.com/emojis/1243943731044810762.webp?size=80&animated=true'},
        ...
        { name: 'add', url: 'https://cdn.discordapp.com/emojis/1374467744585613372.webp?size=80&quality=lossless' },
    ],
    ...
    compliments: [
        ...
        'Akıllara zarar bir mükemmelliğin var.',
        'İyi ki varsın 💕',
        ...
        'Çok güzel bir tablo gördüm, tam alacaktım ama aynaymış...',
        ...
        'Sen beni bir de sevgiliyken gör.',
        'Canın yandı mı? Cennetten düşerken?',
        ...
        'Ölüm ani, dünya fani, bir kere sevsen nolur ki yani?',
        'Bana yüzünü dönme, gece oluyor sanıyorum.',
        'Güneş aya, ben sana tutuldum.',
        'AÇILIN! DÜNYANIN 8. HARİKASI GELDİ!',
        'Ben küçücük bir botum ama sana kocaman sarılırım.',
        'Kafam çok güzel çünkü içinde sen varsın.',
        'Alnın güzelmiş, yazısı olabilir miyim?',
        'Gülüşün şimşek, içermeyiz birer milkshake?',
        'Senin için Google Maps\'ten yol tarifi aldım, kalbine geliyorum.',
    ],
